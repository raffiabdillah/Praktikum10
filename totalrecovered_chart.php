...
{
	$query = mysqli_query($koneksi,"select sum(total_recovered) as total_cases from covid_data where id='$covid'");
	...
	<script>
		...
		var lineChart = new Chart(ctx1, {
			...
			data: {
				...
				datasets: [{
					label: 'Grafik total recovered from Covid',
		...
		var barChart = new Chart(ctx2, {
			...
			data: {
				labels: <?php echo json_encode($label); ?>,
				datasets: [{
					label: 'Grafik Recovered By Covid',
					data: <?php echo json_encode($jumlah_produk); ?>,
